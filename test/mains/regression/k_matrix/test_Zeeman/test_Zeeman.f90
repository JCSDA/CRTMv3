...
! test_Zeeman
!
! Test program for the CRTM K-Matrix function for SSMIS with
...
PROGRAM test_Zeeman
  ...
  CHARACTER(*), PARAMETER :: PROGRAM_RCS_ID = &
    '$Id: test_Zeeman.f90 50587 2015-01-27 20:49:52Z paul.vandelst@noaa.gov $'
...
CONTAINS
  ...
  SUBROUTINE Load_AtmSfc_Data()
    ...
    Surface(1)%Water_Type        = SEA_WATER_TYPE
