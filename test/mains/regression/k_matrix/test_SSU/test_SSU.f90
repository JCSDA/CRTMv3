...
! test_SSU
!
! Test program for the CRTM K-Matrix function for the SSU sensors.
!
...
PROGRAM test_SSU
  ...
  ! Parameters
  ! ----------
  CHARACTER(*), PARAMETER :: PROGRAM_NAME   = 'test_SSU'
  CHARACTER(*), PARAMETER :: PROGRAM_RCS_ID = &
    '$Id: test_SSU.f90 50587 2015-01-27 20:49:52Z paul.vandelst@noaa.gov $'
  ...
  CALL Program_Message( PROGRAM_NAME, &
    'Program for testing the CRTM K-Matrix function for the SSU sensors.', &
