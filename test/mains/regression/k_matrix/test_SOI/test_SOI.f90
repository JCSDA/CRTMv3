...
! test_SOI
!
! Test program for the CRTM K-Matrix function usng the Successive Order
! of Interaction (SOI) radiative transfer solver, rather than the default
! Advanced Doubling-Adding (ADA) algorithm.
!
!
...
PROGRAM test_SOI
  ...
  ! Parameters
  ! ----------
  CHARACTER(*), PARAMETER :: PROGRAM_NAME   = 'test_SOI'
