#https://bin.ssec.wisc.edu/pub/s4/CRTM/fix_REL-3.3.0.0.tgz  (use this for jedi and stand-alone, some files have changed).
...
foldername="fix_REL-3.3.0.0"
checksum=7f32c963782c267d9931114a18b70d85 #md5sum
