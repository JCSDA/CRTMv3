...
MODULE CSEM_Compare_Float_Numbers
  ...
  ! -----------------
  ! Module usage
  USE CSEM_Type_Kinds, ONLY: Single => CSEM_Single,&
                             Double => CSEM_Double
  ...
  CHARACTER(*), PARAMETER :: MODULE_VERSION_ID = &
    '$Id: Compare_Float_Numbers.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
  ! Numeric literals
...
END MODULE CSEM_Compare_Float_Numbers
