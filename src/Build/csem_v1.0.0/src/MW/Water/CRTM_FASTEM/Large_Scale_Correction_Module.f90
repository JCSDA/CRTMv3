...
MODULE Large_Scale_Correction_Module
  ...
  '$Id: Large_Scale_Correction_Module.f90 43902 2014-08-06 20:21:58Z quanhua.liu@noaa.gov $'
  ...
  TYPE :: iInterp_type
    TYPE(CSEM_LPoly_type) :: lp        ! The interpolating polynomial
