...
MODULE CRTM_FastemXX
  ...
  USE CRTM_MWwaterCoeff_Define, ONLY: MWwaterCoeff_type => CRTM_MWwaterCoeff_type

  USE CRTM_FASTEM_Parameters, &
  ...
  PUBLIC :: iVar_type
  ! Science routines
  PUBLIC :: Compute_FastemXX
  PUBLIC :: Compute_FastemXX_TL
  PUBLIC :: Compute_FastemXX_AD
...
!--------------------------------------------------------------------------------
  ...
  END SUBROUTINE Compute_FastemXX
...
!--------------------------------------------------------------------------------
  ...
  SUBROUTINE Compute_FastemXX_TL( &
    MWwaterCoeff    , &  ! Input
  ...
  END SUBROUTINE Compute_FastemXX_TL
...
!--------------------------------------------------------------------------------
  ...
  SUBROUTINE Compute_FastemXX_AD( &
    MWwaterCoeff    , &  ! Input
  ...
  END SUBROUTINE Compute_FastemXX_AD
