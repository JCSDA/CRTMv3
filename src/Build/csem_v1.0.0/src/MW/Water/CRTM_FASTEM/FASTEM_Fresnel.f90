...
MODULE FASTEM_Fresnel
  ...
  PRIVATE
  PUBLIC :: iVar_type
  PUBLIC :: FASTEM_Fresnel_Reflectivity
  PUBLIC :: FASTEM_Fresnel_Reflectivity_TL
  PUBLIC :: FASTEM_Fresnel_Reflectivity_AD
  ...
  '$Id: Fresnel.f90 12622 2011-03-03 23:45:25Z paul.vandelst@noaa.gov $'
...
!
! CALLING SEQUENCE:
!       CALL FASTEM_Fresnel_Reflectivity( permittivity, &  ! Input
!                                  cos_i       , &  ! Input
!                                  Rv          , &  ! Output
!                                  Rh          , &  ! Output
...
!--------------------------------------------------------------------------------
  ...
  SUBROUTINE FASTEM_Fresnel_Reflectivity( permittivity, &  ! Input
                                   cos_i       , &  ! Input
                                   Rv          , &  ! Output
                                   Rh          , &  ! Output
                                   iVar          )  ! Internal variable output
  ...
  END SUBROUTINE FASTEM_Fresnel_Reflectivity
...
!
! CALLING SEQUENCE:
!       CALL FASTEM_Fresnel_Reflectivity_TL( permittivity_TL, &  ! Input
!                                     cos_i          , &  ! Input
!                                     Rv_TL          , &  ! Output
!                                     Rh_TL          , &  ! Output
...
!--------------------------------------------------------------------------------
  ...
  SUBROUTINE FASTEM_Fresnel_Reflectivity_TL( permittivity_TL, &  ! Input
                                      cos_i          , &  ! Input
                                      Rv_TL          , &  ! Output
                                      Rh_TL          , &  ! Output
                                      iVar             )  ! Internal variable input
  ...
  END SUBROUTINE FASTEM_Fresnel_Reflectivity_TL
...
!
! CALLING SEQUENCE:
!       CALL FASTEM_Fresnel_Reflectivity_AD( Rv_AD   , &  ! Input
!                                     Rh_AD          , &  ! Input
!                                     cos_i          , &  ! Input
...
!--------------------------------------------------------------------------------
  ...
  SUBROUTINE FASTEM_Fresnel_Reflectivity_AD( Rv_AD   , &  ! Input
                                      Rh_AD          , &  ! Input
                                      cos_i          , &  ! Input
                                      permittivity_AD, &  ! Output
                                      iVar             )  ! Internal variable input
  ...
  END SUBROUTINE FASTEM_Fresnel_Reflectivity_AD
  
END MODULE FASTEM_Fresnel
