...
MODULE Small_Scale_Correction_Module
  ...
  USE CSEM_FitCoeff_Define, ONLY: CSEM_FitCoeff_1D_type
  ...
  '$Id: Small_Scale_Correction_Module.f90 18621 2012-04-09 01:17:04Z paul.vandelst@noaa.gov $'
...
CONTAINS
  ...
  SUBROUTINE Small_Scale_Correction( &
    ...
    ! Arguments
    TYPE(CSEM_FitCoeff_1D_type), INTENT(IN)     :: SSCCoeff
