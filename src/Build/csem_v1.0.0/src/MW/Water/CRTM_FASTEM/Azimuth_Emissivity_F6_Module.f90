...
MODULE Azimuth_Emissivity_F6_Module
  ...
  USE CSEM_FitCoeff_Define, ONLY: CSEM_FitCoeff_3D_type
  USE CSEM_Search_Utility , ONLY: CSEM_Bisection_Search
  ...
  '$Id: Azimuth_Emissivity_F6_Module.f90 50556 2015-01-27 14:55:12Z paul.vandelst@noaa.gov $'
...
CONTAINS
  ...
  SUBROUTINE Azimuth_Emissivity_F6( &
    ...
    iVar%i1 = CSEM_Bisection_Search(FIT_FREQUENCY, Frequency)
    iVar%i2 = iVar%i1 + 1
