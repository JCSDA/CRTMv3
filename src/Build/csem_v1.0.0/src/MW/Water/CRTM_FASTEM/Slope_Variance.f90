...
MODULE Slope_Variance
  ...
  USE CSEM_Hyperbolic_Step, ONLY: Hyperboic_Step,    &
                             Hyperboic_Step_TL, &
                             Hyperboic_Step_AD
  ...
  '$Id: Slope_Variance.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
...
CONTAINS
  ...
  SUBROUTINE Compute_Slope_Variance_TL( &
    ...
    CALL Hyperboic_Step_TL(iVar%x1,x1_TL,g1_TL)
    ...
    CALL Hyperboic_Step_TL(iVar%x2,x2_TL,g2_TL)
  ...
  SUBROUTINE Compute_Slope_Variance_AD( &
    ...
    x2_AD = ZERO
    CALL Hyperboic_Step_AD(iVar%x2, g2_AD, x2_AD)
    ...
    x1_AD = ZERO
    CALL Hyperboic_Step_AD(iVar%x1, g1_AD, x1_AD)
