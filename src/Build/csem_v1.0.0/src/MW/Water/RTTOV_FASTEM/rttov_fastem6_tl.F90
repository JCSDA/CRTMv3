MODULE RTTOV_FASTEM6_TL_MODULE
...
CONTAINS
  ...
  SUBROUTINE rttov_fastem6_tl(fastem_version,       &  ! Input
                              Frequency   ,         &  ! Input
                              Zenith_Angle,         &  ! Input
                              Temperature ,         &  ! Input
                              Salinity    ,         &  ! Input
  ...
  ! Description:
  ! Tangent-linear of rttov_fastem5
...
! TL internal variables
  ...
  END SUBROUTINE rttov_fastem6_tl

END MODULE RTTOV_FASTEM6_TL_MODULE
