...
CONTAINS
  ...
  SUBROUTINE rttov_fastem6( fastem_version, &         ! Input
                              Frequency   , &         ! Input
                              Zenith_Angle, &         ! Input
                              Temperature , &         ! Input
                              Salinity    , &         ! Input
...
!    REAL(fp) ::
  ...
  ! ----------------------------------
    ...
    IF (PRESENT(Supply_Foam_Fraction) .AND. PRESENT(Foam_Fraction)) THEN
  ...
  END SUBROUTINE rttov_fastem6

END MODULE RTTOV_FASTEM6_MODULE
