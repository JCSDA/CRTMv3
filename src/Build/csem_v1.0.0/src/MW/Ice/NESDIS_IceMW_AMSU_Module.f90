...
MODULE NESDIS_AMSU_ICEEM_Module
  ...
  '$Id: NESDIS_AMSU_SICEEM_Module.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
...
subroutine  NESDIS_AMSU_ICEEM(Satellite_Angle,                                               & ! INPUT
                              User_Angle,                                                    & ! INPUT
                              frequency,                                                     & ! INPUT
                              Ts,                                                            & ! INPUT
                              tba,                                                           & ! INPUT
...
end subroutine NESDIS_AMSU_ICEEM
...
END MODULE NESDIS_AMSU_ICEEM_Module
