...
MODULE NESDIS_MHS_ICEEM_Module
  ...
  '$Id: NESDIS_MHS_SICEEM_Module.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
...
subroutine   NESDIS_MHS_ICEEM(Satellite_Angle,                                               & ! INPUT
                              User_Angle,                                                    & ! INPUT
                              frequency,                                                     & ! INPUT
                              Ts,                                                            & ! INPUT
                              tbb,                                                           & ! INPUT
...
end subroutine NESDIS_MHS_ICEEM
...
END MODULE NESDIS_MHS_ICEEM_Module
