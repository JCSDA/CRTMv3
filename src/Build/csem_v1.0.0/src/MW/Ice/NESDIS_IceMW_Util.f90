!
! NESDIS_MW_IceEmiss_Util
!
! Module containing a simplfied NESDIS physical microwave emissivity model
! to be used by empirical models in angle dependence estimation
!
!
! CREATION HISTORY:
...
!       Modified by:    Ming Chen, Jan 2016
!                       Ming.Chen@noaa.gov
!

MODULE NESDIS_MW_IceEmiss_Util
  ...
  REAL(fp), PARAMETER :: PLANCK_CONSTANT = 6.62606876e-34_fp
  REAL(fp), PARAMETER :: BOLTZMANN_CONSTANT = 1.3806503e-23
  REAL(fp), PARAMETER :: C_2 = PLANCK_CONSTANT * SPEED_OF_LIGHT / BOLTZMANN_CONSTANT
...
!
! PURPOSE:
!       Subroutine to simulate microwave emissivity over snow./ sea ice
!
! REFERENCES:
...
!
!
!         Surf_Temperature:        The surface temperature.
!                                  UNITS:      Kelvin, K
!                                  TYPE:       REAL(fp)
!                                  DIMENSION:  Scalar
!
...
!------------------------------------------------------------------------------------------------------------
  ...
  SUBROUTINE NESDIS_MWEmiss_Ice(Angle,           &   ! Input 
                           Frequency,             &   ! Input
                           Soil_Moisture_Content, &   ! Input
                           Vegetation_Fraction,   &   ! Input
                           Soil_Temperature,      &   ! Input
...
!     leaf_thick = 0.07_fp
  ...
  END SUBROUTINE NESDIS_MWEmiss_Ice
...
END MODULE NESDIS_MW_IceEmiss_Util
