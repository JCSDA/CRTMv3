...
MODULE NESDIS_SSMIS_ICEEM_Module
  ...
  '$Id: NESDIS_SSMIS_SeaIceEM_Module.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
...
!------------------------------------------------------------------------------------------------------
  ...
  call NESDIS_MWEmiss_Ice(SSMIS_Angle,frequency,&
      0.0_fp,0.0_fp,Ts,Ts,0.0_fp,9,13,local_depth,esh1,esv1)

  call NESDIS_MWEmiss_Ice(Angle,frequency,&
      0.0_fp,0.0_fp,Ts,Ts,0.0_fp,9,13,local_depth,esh2,esv2)
...
! h-component
 ...
 END MODULE NESDIS_SSMIS_ICEEM_Module
