...
MODULE NESDIS_AMSRE_ICEEM_Module
  ...
  '$Id: NESDIS_AMSRE_SICEEM_Module.f90 99117 2017-11-27 18:37:14Z tong.zhu@noaa.gov $'
...
!------------------------------------------------------------------------------------------------------------
 ...
 subroutine NESDIS_AMSRE_ICEEM(frequency,                                         &  ! INPUT
                                 User_Angle,                                        &  ! INPUT
                                 tv,                                                &  ! INPUT
                                 th,                                                &  ! INPUT
                                 Ts,                                                &  ! INPUT
...
! Get the emissivity angle dependence
  ...
  call NESDIS_MWEmiss_Ice(Satellite_Angle,frequency,&
     0.0_fp,0.0_fp,Ts,Tice,0.0_fp,9,13,10.0_fp,esh1,esv1)

  call NESDIS_MWEmiss_Ice(User_Angle,frequency,&
     0.0_fp,0.0_fp,Ts,Tice,0.0_fp,9,13,10.0_fp,esh2,esv2)
...
! Emissivity at User's Angle
 ...
 end subroutine NESDIS_AMSRE_ICEEM
...
END MODULE NESDIS_AMSRE_ICEEM_Module
