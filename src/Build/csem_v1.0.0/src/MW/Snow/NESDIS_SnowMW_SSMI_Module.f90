...
MODULE NESDIS_SSMI_SnowEM_Module
  ...
  '$Id: NESDIS_SSMI_SnowEM_Module.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
...
! Get the emissivity angle dependence
  ...
  call NESDIS_MWEmiss_Snow(SSMI_Angle,frequency,&
      0.0_fp,0.0_fp,Ts,Ts,0.0_fp,9,13,Depth,esh1,esv1)

  call NESDIS_MWEmiss_Snow(Angle,frequency,&
