...
MODULE NESDIS_AMSRE_SNOWEM_Module
  ...
  '$Id: NESDIS_AMSRE_SNOWEM_Module.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
...
!------------------------------------------------------------------------------------------------------------
 ...
 subroutine NESDIS_AMSRE_SNOWEM(Frequency,                              & ! INPUT
                              User_Angle,                             & ! INPUT
                              tv,                                     & ! INPUT
                              th,                                     & ! INPUT
                              Ts,                                     & ! INPUT
...
! Get the emissivity angle dependence
  ...
  call NESDIS_MWEmiss_Snow(Satellite_Angle,Frequency,&
       0.0_fp,0.0_fp,Ts,Tsnow,0.0_fp,9,13,10.0_fp,esh1,esv1)

  call NESDIS_MWEmiss_Snow(User_Angle,Frequency,&
       0.0_fp,0.0_fp,Ts,Tsnow,0.0_fp,9,13,10.0_fp,esh2,esv2)
...
! Emissivity at User's Angle
 ...
 end subroutine NESDIS_AMSRE_SNOWEM
