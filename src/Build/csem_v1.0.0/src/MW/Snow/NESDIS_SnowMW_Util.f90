...
MODULE NESDIS_MW_SnowEmiss_Util
...
!------------------------------------------------------------------------------------------------------------
  ...
  SUBROUTINE NESDIS_MWEmiss_Snow(Angle,           &   ! Input 
                           Frequency,             &   ! Input
                           Soil_Moisture_Content, &   ! Input
                           Vegetation_Fraction,   &   ! Input
                           Soil_Temperature,      &   ! Input
...
!     leaf_thick = 0.07_fp
  ...
  END SUBROUTINE NESDIS_MWEmiss_Snow
...
END MODULE NESDIS_MW_SnowEmiss_Util
