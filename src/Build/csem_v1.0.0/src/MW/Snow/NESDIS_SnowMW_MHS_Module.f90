...
MODULE NESDIS_MHS_SNOWEM_Module
  ...
  '$Id: NESDIS_MHS_SnowEM_Module.f90 21141 2012-09-14 17:40:43Z paul.vandelst@noaa.gov $'
...
subroutine  NESDIS_MHS_SNOWEM(Satellite_Angle,                                               & ! INPUT
                              User_Angle,                                                    & ! INPUT
                              frequency,                                                     & ! INPUT
                              Ts,                                                            & ! INPUT
                              tbb,                                                           & ! INPUT
...
end subroutine NESDIS_MHS_SNOWEM
...
!-----------------------------------------------------------------------------------------------
   ...
   integer :: ich,jch,k
   real(fp)    :: angle,frequency,emissivity=1.0_fp
   real(fp)    :: freq(nchanw),tb(nchanw),em_vector(2)
   real(Double)     :: coe(nchanw,ncoe),emiss(nchanw)
