...
!
! PURPOSE:
!       Function to simulate Infrared emissivity over  Ice conditions.
!
! REFERENCES:
...
!
! CALLING SEQUENCE:
!              Error_Status = NESDIS_IceIR_Emiss(               &
!                                  Frequency,                   &  ! Input
!                                  Angle,                       &  ! Input
...
!------------------------------------------------------------------------------------------------------------
  ...
  END FUNCTION NESDIS_IceIR_Emiss


END MODULE NESDIS_IceIR_PhyModel
