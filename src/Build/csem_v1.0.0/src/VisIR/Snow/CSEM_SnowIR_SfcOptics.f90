...
!:sdoc+:
!
! CSEM_SnowIR_SfcOptics
!
!
! Module to compute the surface optical properties of Snow surfaces at infrared 
...
! functions as those in the original CRTM surface module "CRTM_SnowIR_SfcOptics", 
...
MODULE CSEM_SnowIR_SfcOptics
  ...
  ! Data types
  ! Science routines
  PUBLIC :: CSEM_Compute_SnowIR_SfcOptics
  PUBLIC :: CSEM_Compute_SnowIR_SfcOptics_TL
  PUBLIC :: CSEM_Compute_SnowIR_SfcOptics_AD
  PUBLIC :: iVar_type
...
!       frequencies over a Snow surface.
!
!       This function encapsulates all available  CSEM SnowIR emissivity models,and
!       provides a genereic interface for the upper-level user application.
!
! CALLING SEQUENCE:
!       IO_Status = CSEM_Compute_SnowIR_SfcOptics( 
!                                        Surface                  ,&  ! Input
!                                        SfcOptics                ,&  ! Output
...
!
!       Options:         CSEM inpput extension structure containing additional inputs,
...
!-----------------------------------------------------------------------------------------------
  ...
  FUNCTION CSEM_Compute_SnowIR_SfcOptics(  &
      Surface,                             &  ! Input
      SfcOptics,                           &  ! Output
    ...
    ! Local parameters
    CHARACTER(*), PARAMETER :: ROUTINE_NAME = 'CSEM_Compute_SnowIR_SfcOptics'
    ! Local variables
  ...
  END FUNCTION CSEM_Compute_SnowIR_SfcOptics
...
!
! CALLING SEQUENCE:
!       IO_Status = CSEM_Compute_SnowIR_SfcOptics_TL( SfcOptics_TL )
!
! OUTPUTS:
...
!----------------------------------------------------------------------------------
  ...
  FUNCTION CSEM_Compute_SnowIR_SfcOptics_TL(  &
    ...
    ! Local parameters
    CHARACTER(*), PARAMETER :: ROUTINE_NAME = 'CSEM_Compute_SnowIR_SfcOptics_TL'
  ...
  END FUNCTION CSEM_Compute_SnowIR_SfcOptics_TL
...
!
! CALLING SEQUENCE:
!       IO_Status = CSEM_Compute_SnowIR_SfcOptics_AD( SfcOptics_AD )
!
! INPUTS:
...
!----------------------------------------------------------------------------------
  ...
  FUNCTION CSEM_Compute_SnowIR_SfcOptics_AD(  &
       Surface_AD)                            &  ! AD  Input
    RESULT( IO_Status )
    ...
    INTEGER :: IO_Status
    ! Local parameters
    CHARACTER(*), PARAMETER :: ROUTINE_NAME = 'CSEM_Compute_SnowIR_SfcOptics_AD'
  ...
  END FUNCTION CSEM_Compute_SnowIR_SfcOptics_AD

END MODULE CSEM_SnowIR_SfcOptics
