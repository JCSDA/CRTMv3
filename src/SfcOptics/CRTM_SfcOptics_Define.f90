...
MODULE CRTM_SfcOptics_Define
  ...
  '$Id: CRTM_SfcOptics_Define.f90 100697 2018-12-21 18:33:44Z tong.zhu@noaa.gov $'
  ! -----------------------------------
  ...
  TYPE :: CRTM_SfcOptics_type
    ...
    ! reshape, temporal surface part
    REAL(fp), ALLOCATABLE :: S_Emissivity(:)      ! (I x Ls)
    REAL(fp), ALLOCATABLE :: S_Direct_Ref(:)      ! (I x Ls)
    REAL(fp), ALLOCATABLE :: S_Reflectivity(:,:)  ! (I x Ls) x (I x Ls)
...
!--------------------------------------------------------------------------------
  ...
  ELEMENTAL SUBROUTINE CRTM_SfcOptics_Create( &
    ...
    ALLOCATE( self%Angle( n_Angles ), &
              ...
              self%S_Emissivity( n_Angles*n_Stokes ), &
              self%S_Reflectivity( n_Angles*n_Stokes, n_Angles*n_Stokes), &
              self%S_Direct_Ref( n_Angles*n_Stokes ), &              
              STAT = alloc_stat )
    ...
    self%S_Emissivity          = ZERO
    self%S_Reflectivity        = ZERO
    self%S_Direct_Ref          = ZERO
