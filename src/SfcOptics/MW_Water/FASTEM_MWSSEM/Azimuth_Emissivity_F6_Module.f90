...
CONTAINS
  ...
  SUBROUTINE Azimuth_Emissivity_F6( &
    ...
    Frequency_Loop: DO j = 1, N_FREQUENCIES
      ...
      ! FASTEM4, FASTEM5 or PARMIO, which is indistinguishable from a scene
      ! that genuinely has no polarimetric signal. Select the backend with
      ! the MWwaterCoeff_Scheme argument, not MWwaterCoeff_File.
